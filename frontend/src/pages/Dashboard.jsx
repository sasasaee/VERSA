                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center justify-between border-t border-skin-muted/20 pt-4">
                                    ...
                                    >
                                      ...
                                      <div className={`absolute inset-0 bg-skin-secondary/20 rounded-full blur-md transition-opacity duration-500 ${
                                                isLiked(story.upvotes) ? "opacity-100 scale-150" : "opacity-0 scale-0"
                                            }`} />
                                        ...
                                        <span className={`font-medium text-sm transition-colors duration-300 ${
                                            isLiked(story.upvotes) ? "text-skin-secondary font-bold" : "text-skin-muted"
                                        }`}>
